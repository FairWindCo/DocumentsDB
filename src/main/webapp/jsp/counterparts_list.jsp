        ...
        $("#grid").jqGrid({
            ...
            subGridRowExpanded: function(subgrid_id, row_id) {
                ...
                jQuery("#"+tree_table_id).jqGrid({
                    ...
                    styleUI : 'Bootstrap',
                    /**/
                    colNames: ['<c:message code="label.id"/>','<c:message code="label.persons.surname"/>','<c:message code="label.persons.firstName"/>','<c:message code="label.persons.middleName"/>','<c:message code="label.persons.date_of_birth"/>','<c:message code="label.persons.head"/>','<c:message code="label.persons.head"/>'],
                    colModel: [
