...
<div id="page-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="active"><c:message code="label.globaldirectory.nuomanlature_types"/></li>
    </ol>
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><c:message code="label.globaldirectory.nuomanlature_types.title"/></h3>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#grid").jqGrid({
            url:'${pageContext.request.contextPath}/nomenclaturetypes/listing',
            editurl:'${pageContext.request.contextPath}/nomenclaturetypes/edit',
            datatype: 'json',
            mtype: 'POST',
            styleUI : 'Bootstrap',
            colNames:['<c:message code="label.id"/>', '<c:message code="label.name"/>', '<c:message code="label.description"/>', '<c:message code="label.version"/>'],
            colModel:[
            ...
            viewrecords: true,
            sortorder: "asc",
            caption:"<c:message code="label.globaldirectory.nomanklature_types"/>",
