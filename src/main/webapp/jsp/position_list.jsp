...
<div id="page-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="active"><c:message code="label.globaldirectory.position"/></li>
    </ol>
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><c:message code="label.globaldirectory.position.title"/></h3>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#grid").jqGrid({
            url:'${pageContext.request.contextPath}/position/listing',
            editurl:'${pageContext.request.contextPath}/position/edit',
            datatype: 'json',
            mtype: 'POST',
            styleUI : 'Bootstrap',
