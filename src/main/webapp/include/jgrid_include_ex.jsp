...
<script src="<c:url value="/resources/script/jqgrid/jqgrid-ext.js"/>"></script>
<script src="<c:url value="/resources/script/jquery_form/jquery.form.js"/>"></script>
...
<link rel="stylesheet" type="text/css" media="screen" href="<c:url value="/resources/script/jqgrid/jqgrid-ext.css"/>" />
